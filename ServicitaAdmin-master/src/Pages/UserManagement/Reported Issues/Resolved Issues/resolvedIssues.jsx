...
function ResolvedIssues() {
	...
	return (
		<div className='reviewComplaints1'>
		  <div>
			<h1 className='DashboardHeader'>Resolved Issues</h1>
		  </div>
		  <div className='message-container'>
			{showSpinner ? (
			  ...
			  filterByStatus.length === 0 ? (
				<div style={{padding: '10px 0px 0px 10px'}} >No current Resolved Issues to review</div>
			  ) : (
				<div className='complaints-scroller1'>
				  {changes ? (
					...
					<>
                      ...
                      Resolved Issues to Review: {filterByStatus.length}
					  </div>
